...
/* Monitor custom errors */
#define EBUFFSIZE  200 /* Invalid buffer size */
#define ENOBUFF    201 /* Buffer does not exist */
#define ENODT      202 /* Invalid data type */
#define ENOWRDT    203 /* Invalid write data */
#define ENOBUFFULL 204 /* Buffer is not full */
